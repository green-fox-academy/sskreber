...
public class ConnectionWithMySqlSecondApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Todo oneTodo = new Todo("Lose temper", false, true);
        Todo myTodo = new Todo("Finally chill a bit", false, false);

        assigneeRepository.save(new Assignee("Eddie", "izzarde@gmail.com"));
        assigneeRepository.save(new Assignee("Scar", "theblacklioninthefamily@gmail.com"));
        assigneeRepository.save(new Assignee("Ada Lovelace", "lovelace@gmail.com"));
        assigneeRepository.save(new Assignee("Bill Gates", "therealbill@gmail.com"));
        assigneeRepository.save(new Assignee("Zuckerberg", "markz@gmail.com"));
        ...
        oneTodo.setAssignee(meAsAssignee);
        todoRepository.save(myTodo);
        todoRepository.save(oneTodo);
    }
}
