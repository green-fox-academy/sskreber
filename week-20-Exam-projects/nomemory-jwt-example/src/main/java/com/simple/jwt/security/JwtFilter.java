...
public class JwtFilter implements Filter {
    ...
    @Autowired
    private JwtService jwtService; //could have been named jwtTokenService
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
    {
        ...
        final String authHeaderValue = httpRequest.getHeader(authHeader);
        ...
        try {
            JwtUser jwtUser = jwtService.getUser(authHeaderValue);
