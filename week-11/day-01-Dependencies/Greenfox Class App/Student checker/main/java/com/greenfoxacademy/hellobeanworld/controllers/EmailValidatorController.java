...
public class EmailValidatorController {
    ...
    private static final String VALID_EMAIL_MESSAGE = " is a valid email address.";
    private static final String INVALID_EMAIL_MESSAGE = " is not a valid email address.";
    private static final String EMAIL_PROMPT = " Please enter an email address into the URL to use this function.";
