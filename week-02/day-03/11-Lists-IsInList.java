...
public class IsInList {
    public static void main(String... args) {
        ...
        // sskreber: added the following two extra lines instead of the one above, to initialise arraylist & give it its content.
        ArrayList<Integer> list = new ArrayList<>();
        list.addAll(Arrays.asList(2, 4, 6, 8, 10, 12, 14, 16));
